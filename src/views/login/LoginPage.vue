...
const rules = {
  username: [
    { required: true, message: 'Plz input username', trigger: 'blur' },
    { min: 5, max: 10, message: '5-10length ', trigger: 'blur' }
  ],
  password: [
    { required: true, message: 'Plz input passwd', trigger: 'blur' },
    { pattern: /^\S{6,15}/, message: '6-15 length' }
  ],
  repassword: [
    { required: true, message: 'Plz input passwd', trigger: 'blur' },
    { pattern: /^\S{6,15}/, message: '6-15 length' },
...
const login = async () => {
  ...
  userSotre.setToken(res.data.token)
